...
public class CoachMarkView extends RelativeLayout {
    ...
    private CoachmarkListener callback;
    private CoachmarkUtils showTipsStore;
    ...
    private void init() {
        ...
        showTipsStore = new CoachmarkUtils(getContext());
    }
    ...
    public CoachmarkListener getCallback() {
        return callback;
    }

    public void setCallback(CoachmarkListener callback) {
