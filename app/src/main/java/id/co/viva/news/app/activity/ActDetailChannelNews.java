...
public class ActDetailChannelNews extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.list_channel_news);
                        ...
                        public void onResponse(String volleyResponse) {
                            ...
                            try {
                                ...
                                if (channelNewsArrayList.size() > 0 || !channelNewsArrayList.isEmpty()) {
                                    mAnimAdapter = new ScaleInAnimationAdapter(new ChannelNewsAdapter(VivaApp.getInstance(), channelNewsArrayList));
